-- ========================================
-- COMPLETE DATABASE MIGRATION FOR VOICEAGENTS
-- ========================================
-- This script contains all the database changes made to the voiceagents project
...
-- ========================================
-- 4. ADD RECORDING FIELDS TO CALL_HISTORY
-- ========================================
...
WHERE table_name = 'user_twilio_credentials' 
...
-- Your voiceagents project is now ready to use with the complete schema.
